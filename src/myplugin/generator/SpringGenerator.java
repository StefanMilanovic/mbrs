...
public class SpringGenerator extends BasicGenerator {	
	...
	public Writer getWriter(String fileNamePart, String packageName) throws IOException {
		...
		else if(templateName.equals("Repository")) {
			generatedFileName = fileNamePart + "Repository";
		}else if(templateName.equals("Service")) {
			generatedFileName = fileNamePart + "Service";
		}else if(templateName.equals("ServiceImpl")) {
			generatedFileName = fileNamePart + "ServiceImpl";
		}else if(templateName.equals("FrontFTL")){
			generatedFileName = fileNamePart.toLowerCase();
		}else if(templateName.equals("FrontFilter")){
			generatedFileName = fileNamePart.toLowerCase() + "Filter";
		}else if(templateName.equals("Index")){
